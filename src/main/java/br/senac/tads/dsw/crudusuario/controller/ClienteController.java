...
public class ClienteController {
	...
	public ModelAndView salvar(@ModelAttribute @Valid Cliente cliente, Errors error,
			@RequestParam(value = "cargo[]", required = false) Integer[] cargo, RedirectAttributes redirAttr,
		...
		try {
			...
			if (!Objects.isNull(cliente)) {
				...
				redirAttr.addFlashAttribute("mensagem",
						"Cliente salvo com sucesso! às " + MetodosUtilitarios.getDataHora());
